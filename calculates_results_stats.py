   ...
   # Creates empty dictionary for results_stats_dic
    ...
    for key in results_dic:
        ...
        # Pet Image Label is NOT a Dog
            ...
            # Classifier classifies image as NOT a Dog (& pet image isn't a dog) - counts number of correct NOT dog classifications
...
# REFERENCE
# https://github.com/shamjam/Use-a-Pre-trained-Image-Classifier-to-Identify-Dog-Breeds/blob/master/calculates_results_stats.py
